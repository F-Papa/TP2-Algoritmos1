...
path_archivo = 'C:\\Users\\franc\\source\\repos\\SMN TP\\weatherdata--389-603.csv'   # (Solo para pruebas internas)
...
def main():
    ...
    print(get_promedio(lineas_archivo, 8, 8))
    print(get_max(lineas_archivo, 4, 8))
    print(get_max(lineas_archivo, 8, 8))
    
#main() # (Solo para pruebas internas)
